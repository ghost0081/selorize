...
class _HomeContentState extends State<HomeContent> {
  ...
  List<Map<String, dynamic>> _apiTestimonials = [];
  ...
  Future<void> _loadPopularBrands() async {
    ...
    try {
      final results = await Future.wait([
        ...
        _repo.getData(tableName: 'testimonial'),
      ]);
      if (!mounted) return;
      setState(() {
